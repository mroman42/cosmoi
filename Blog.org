...
* Lawful mixed optics                                                                         :post:
:PROPERTIES:
:TITLE: Lawful mixed optics
:EXPORT_FILE_NAME: docs/_posts/2019-11-05-lawfulmixed.html
...
* TODO Tannakian reconstruction of Tambara modules                                            :post:
:PROPERTIES:
...
* TODO Kaleidoscopes, monoidal lenses, comonoidal prisms                                      :post:
:PROPERTIES:
...
* TODO Capturando links en org-mode                                                           :post:
:PROPERTIES:
...
* TODO Distribuciones discretas con mónadas                                                   :post:
:PROPERTIES:
...
#+BEGIN_SRC haskell
  ...
  main = return ()
#+END_SRC
* TODO Inducción estructural                                                                  :post:
:PROPERTIES:
