...
:PROPERTIES:
:TITLE: Mikrokosmos
:EXPORT_FILE_NAME: docs/mikrokosmos.html
...
Thanks to [[https://github.com/ghcjs/ghcjs][GHCJS]] and [[http://codemirror.net/][Codemirror]], you can also try the [[https://github.com/M42/mikrokosmos][Mikrokosmos]]
...
:EXPORT_FILE_NAME: docs/capturandolinksenorgmode.html
...
:EXPORT_FILE_NAME: docs/induccionestructural.html
...
:PROPERTIES:
:TITLE:    Mónadas
:EXPORT_FILE_NAME: docs/monadas.html
...
:EXPORT_FILE_NAME: docs/matematicasemacs.html
