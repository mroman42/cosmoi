...
:EXPORT_FILE_NAME: docs/evaluacionlambda.html
...
** Try Mikrokosmos!                                                                          :post:
:PROPERTIES:
:TITLE: Try Mikrokosmos!
:EXPORT_FILE_NAME: docs/trymikrokosmos.html
...
** Mikrokosmos 0.3.0                                                                         :post:
:PROPERTIES:
:TITLE:    Mikrokosmos 0.3.0
:EXPORT_FILE_NAME: docs/mikrokosmos03.html
...
:EXPORT_FILE_NAME: docs/aprendiendoemacs.html
:EXPORT_DATE: <2018-05-25 Fri 18:34>
:END:
...
:EXPORT_FILE_NAME: docs/distribucionesmonadas.html
:EXPORT_DATE: <2018-05-25 Fri 18:34>
:END:
...
#+HTML: <script src="https://gist.github.com/mroman42/7d9d2ecf174bad73804e67fd5cb8de72.js"></script>
...
:PROPERTIES:
:TITLE:  About
:EXPORT_FILE_NAME: docs/about.html
:END:

I'm *Mario Román*. I study Mathematics and Computer science in
Granada. I also write in the [[http://tux.ugr.es/dgiim/][LibreIM]] blog.
...
#+BEGIN_SRC emacs-lisp :results output html :exports results
(print-index)
#+END_SRC
#+RESULTS:
#+BEGIN_EXPORT html
<ul>
 ...
 <li><a href=trymikrokosmos.html> Try Mikrokosmos! </a> - <em><2018-05-25 Fri 18:01></em><br></li>
 <li><a href=mikrokosmos03.html> Mikrokosmos 0.3.0 </a> - <em><2018-05-25 Fri 18:34></em><br></li>
...
# eval: (defun print-post-at-point () (princ (concat  " <li><a href=" (substring (concat (org-entry-get (point) "EXPORT_FILE_NAME")  "> ") 5) (org-entry-get (point) "TITLE") " </a>" " - <em>" (org-entry-get (point) "EXPORT_DATE") "</em><br></li>\n")))
# eval: (defun print-index () (progn (princ "<ul>\n") (org-map-entries (lambda () (print-post-at-point)) "+post" nil) (princ "</ul>\n")))
# End:
